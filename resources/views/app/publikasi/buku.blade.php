        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">Data Buku Ajar Universitas Nurul Jadid</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Grafik Jumlah Buku Ajar</div>
                                    <div class="panel-body">
                            ...
                            <div class="reg-items">
                                <div class="col-md-12">
                                    <form action="{{ route('detailpencarianbukuajar') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                        ...
                                                        @foreach ($d as $prodi)
                                                            @foreach ($prodi as $p)
                                                                <li class="list-group-item">
                                                                    ...
                                                                    <a href="{{ route('detailbuku', $p['nama_prodi']) }}">
                                                                        {{ $p['nama_prodi'] }}</a>
                                                                </li>
                                                            @endforeach
                                                        @endforeach
