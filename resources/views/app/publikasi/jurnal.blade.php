        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">Data Prosiding Universitas Nurul Jadid</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Grafik Jumlah Prosiding</div>
                                    <div class="panel-body">
                            ...
                            <div class="reg-items">
                                <div class="col-md-12">
                                    <form action="{{ route('detailpencarianprosiding') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                        ...
                                                        @foreach ($d as $prodi)
                                                            @foreach ($prodi as $p)
                                                                <li class="list-group-item">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('detailprosiding', $p['nama_prodi']) }}">
                                                                        {{ $p['nama_prodi'] }}</a>
                                                                </li>
                                                            @endforeach
                                                        @endforeach
