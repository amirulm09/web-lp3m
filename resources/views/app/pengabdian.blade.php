        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">Data Pengabdian Universitas Nurul Jadid</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Grafik Jumlah Pengabdian</div>
                                    <div class="panel-body">
                            ...
                            <div class="reg-items">
                                <div class="col-md-12">
                                    <form action="{{ route('detailpencarian') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
